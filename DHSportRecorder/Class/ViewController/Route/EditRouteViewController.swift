...
class EditRouteViewController: BaseViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        date = Date.getDateFromString(route.startTime!, format: Date.JSONFormat)
        sDate = Date.getDateFromString(route.startTime!, format: Date.JSONFormat)
        eDate = Date.getDateFromString(route.endTime!, format: Date.JSONFormat)
